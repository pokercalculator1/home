...
          background: linear-gradient(90deg,#7f1d1d,#f59e0b,#16a34a); /* MUDADO: Gradiente aqui */
          border-radius: 999px; /* ADICIONADO: Para preencher os cantos */
        }
        /* === FIM DA CORREÇÃO === */
        
